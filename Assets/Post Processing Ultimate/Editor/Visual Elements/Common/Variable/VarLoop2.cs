...
namespace DawidMoza.PostProcessingUltimate {
    public class VarLoop2 : VisualElement {

        public const string tooltip = "Performs arithmetic operations on a double value";
        ...
        public VarLoop2() {
            ...
            AddJoint(VisualJoint.LEFT, 2, "Input", "Input value");
