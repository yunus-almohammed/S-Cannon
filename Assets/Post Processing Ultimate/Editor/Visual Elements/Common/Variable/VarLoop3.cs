...
namespace DawidMoza.PostProcessingUltimate {
    public class VarLoop3 : VisualElement {

        public const string tooltip = "Performs arithmetic operations on a triple value";
        ...
        public VarLoop3() {
            ...
            AddJoint(VisualJoint.LEFT, 3, "Input", "Input value");
