...
namespace DawidMoza.PostProcessingUltimate {
    public class Ddy : VisualElement {

        public const string tooltip = "Returns the partial derivative of the specified value with respect to the screen-space y-coordinate";
