...
namespace DawidMoza.PostProcessingUltimate {
	[Serializable]
	[PostProcess(typeof(EightColors2Renderer), PostProcessEvent.AfterStack, "PPU/EightColors2")]
	public sealed class EightColors2 : PostProcessEffectSettings {
		[Tooltip("Base color")]
		public ColorParameter Start = new ColorParameter {value = new Color(0f, 0f, 0f, 0f)};
	...
	public sealed class EightColors2Renderer : PostProcessEffectRenderer<EightColors2> {
		public override void Render(PostProcessRenderContext context) {
			var sheet = context.propertySheets.Get(Shader.Find("PPU/EightColors2"));
			sheet.properties.SetColor("_Start", settings.Start);
